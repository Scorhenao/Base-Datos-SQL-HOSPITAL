...
VALUES
    ...
    ('Disponible',3,3),    -- Laura Martínez
    ('Ocupado',4,4),    -- Carlos Sánchez
    ('Disponible',5,5),    -- Ana López
    ('Ocupado',6,6),    -- Jorge Rodríguez
    ('Disponible',7,7),    -- Sofía Fernández
    ('Ocupado',8,8),    -- Miguel Torres
    ('Disponible',9,9),    -- Elena Gómez
    ('Ocupado',10,10),   -- Diego García
    ('Disponible',11,11),   -- Patricia Ruiz
    ('Ocupado',12,12),   -- Ricardo Vargas
    ('Disponible',13,13),   -- Alejandra Pérez
    ('Ocupado',14,14),   -- Mario Hernández
    ('Disponible',15,15),   -- Luisa Ramírez
    ('Ocupado',16,16),   -- Andrés Gutiérrez
    ('Disponible',17,17),   -- Fabiola Díaz
    ('Ocupado',18,18),   -- Roberto Castro
    ('Disponible',19,19),   -- Claudia Morales
