...
-- INSERT CAMAS
INSERT INTO CAMAS (ID_paciente_FK, ID_salaUCI_FK)
VALUES
    (1,1),    -- María González
    (2,2),    -- Pedro Ramírez
    (3,3),    -- Laura Martínez
    ...
    (10,10),   -- Diego García
    (11,11),   -- Patricia Ruiz
    (12,12),   -- Ricardo Vargas
    (13,13),   -- Alejandra Pérez
    (14,14),   -- Mario Hernández
    (15,15),   -- Luisa Ramírez
    (16,16),   -- Andrés Gutiérrez
    (17,17),   -- Fabiola Díaz
    (18,18),   -- Roberto Castro
    (19,19),   -- Claudia Morales
    (20,20);   -- Ana María López
...
INSERT INTO EXAMENES (Fecha, ID_paciente_FK, ID_medico_FK)
VALUES
